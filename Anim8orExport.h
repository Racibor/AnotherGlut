...
typedef struct Anim8orMaterial {
	...
	char *bumpmapTexture;
	char *environmentTexture;   // Dodane dla kompatybilnoœci z Anim8or 1.00
	char *texture;              // Dodane dla kompatybilnoœci z Anim8or 1.00
} Anim8orMaterial;
...
typedef struct Anim8orObject {
    const char *name;
    int nMeshes;
    Anim8orMesh *meshes[128];   // "128" dodane dla kompatybilnoœci z Code::Blocks i gcc
} Anim8orObject;
